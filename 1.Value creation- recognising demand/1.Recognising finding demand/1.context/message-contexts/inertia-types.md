...
## Purpose
Every message you write is competing against one of these 4 mental models — not against another coach or tool.
If your message doesn't confront one of these directly, founders will default to doing nothing.

Before writing any message ask: **Which inertia am I writing against?**
If you can't answer this — you don't have a message yet.
...
The inertia type is the **bridge** between the founder's signal and your message.
It tells you what mental model you need to break before the founder will even consider moving.
